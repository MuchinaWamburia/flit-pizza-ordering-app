         ...
         <div className="ps-4">
            ...
            <Link href={'/products'}>
              ...
              <div className="flex justify-end">
                ...
                <Image src={"/Pizza-2.png"} width={400} height={400} alt="Tomato Pizza" className="h-[200px] lg:h-[250px] xl:h-[400px] w-[200px] lg:w-[250px] xl:w-[400px]"/>
                ...
                <Image src={"/Pizza.png"} width={170} height={170} alt="Nut Pizza" className="h-[120px] xl:h-[170px] w-[120px] xl:w-[170px] absolute right-[0px] lg:right-[-20px] bottom-[-50px] xl:bottom-[-130px]"/>
            </div>
